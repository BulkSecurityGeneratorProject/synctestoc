...
public class OcConfigurationResource {
     ...
     */
    @RequestMapping(value = "/ocConfigurations",
     ...
     */
    @RequestMapping(value = "/ocConfigurations/{id}",
            method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OcConfiguration> get(@PathVariable Long id, HttpServletResponse response) {
